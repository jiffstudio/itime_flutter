...
import 'locationTimeResult.dart';
...
class LocationSearchResult {
  ...
  final int colorId;
  final List<LocationTimeResult> time;
  ...
  factory LocationSearchResult.fromJson(Map<String,dynamic> json) => LocationSearchResult(
    ...
    time: (json['time'] as List? ?? []).map((e) => LocationTimeResult.fromJson(e)).toList(),
  ...
  LocationSearchResult clone() => LocationSearchResult(
    eventId: eventId,
    name: name,
    location: location,
    tableId: tableId,
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is LocationSearchResult && eventId == other.eventId && name == other.name && location == other.location && tableId == other.tableId && colorId == other.colorId && time == other.time && eventType == other.eventType && compulsory == other.compulsory && teacher == other.teacher && courseCode == other.courseCode && courseNo == other.courseNo;
