...
/// shows a popup menu, consider using [OverlayMenuButton].
///
...
/// [OverlayMenuItem]), or no value at all (for example, [PopupMenuDivider]).
///
/// See also:
///
///  * [OverlayMenuItem], a popup menu entry for a single value.
///  * [PopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [CheckedPopupMenuItem], a popup menu item with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [OverlayMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
...
/// See also:
///
///  * [OverlayMenuItem], for the kinds of items that this widget divides.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [OverlayMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
...
///
/// Typically the [child] of a [OverlayMenuItem] is a [Text] widget. More
/// elaborate menus with icons can use a [ListTile]. By default, a
/// [OverlayMenuItem] is [kMinInteractiveDimension] pixels high. If you use a widget
...
/// {@end-tool}
///
/// See the example at [OverlayMenuButton] for how this example could be used in a
/// complete menu, and see the example at [CheckedPopupMenuItem] for one way to
/// keep the text of [OverlayMenuItem]s that use [Text] widgets in their [child]
/// slot aligned with the text of [CheckedPopupMenuItem]s or of [OverlayMenuItem]
/// that use a [ListTile] in their [child] slot.
///
/// See also:
///
///  * [PopupMenuDivider], which can be used to divide items from each other.
///  * [CheckedPopupMenuItem], a variant of [OverlayMenuItem] with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [OverlayMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class OverlayMenuItem<T> extends PopupMenuEntry<T> {
  ...
  @override
  PopupMenuItemState<T, OverlayMenuItem<T>> createState() =>
      PopupMenuItemState<T, OverlayMenuItem<T>>();
}

/// The [State] for [OverlayMenuItem] subclasses.
///
/// By default this implements the basic styling and layout of Material Design
/// popup menu items.
///
/// The [buildChild] method can be overridden to adjust exactly what gets placed
/// in the menu. By default it returns [OverlayMenuItem.child].
///
/// The [handleTap] method can be overridden to adjust exactly what happens when
/// the item is tapped. By default, it uses [Navigator.pop] to return the
/// [OverlayMenuItem.value] from the menu route.
///
/// This class takes two type arguments. The second, `W`, is the exact type of
/// the [Widget] that is using this [State]. It must be a subclass of
/// [OverlayMenuItem]. The first, `T`, must match the type argument of that widget
/// class, and is the type of values returned from this menu.
class PopupMenuItemState<T, W extends OverlayMenuItem<T>> extends State<W> {
  /// The menu item contents.
  ///
  /// Used by the [build] method.
  ///
  /// By default, this returns [OverlayMenuItem.child]. Override this to put
  ...
  ///
  /// By default, uses [Navigator.pop] to return the [OverlayMenuItem.value] from
  /// the menu route.
  @protected
  void handleTap() {
...
/// matches the default minimum height of a [OverlayMenuItem]. The horizontal
...
/// See also:
///
///  * [OverlayMenuItem], a popup menu entry for picking a command (as opposed to
///    toggling a value).
///  * [PopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [OverlayMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class CheckedPopupMenuItem<T> extends OverlayMenuItem<T> {
...
///  * [PopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [CheckedPopupMenuItem], a popup menu item with a checkmark.
///  * [OverlayMenuButton], which provides an [IconButton] that shows a menu by
...
/// argument is the value of the [OverlayMenuItem] that caused its menu to be
/// dismissed.
///
/// Used by [OverlayMenuButton.onSelected].
typedef PopupMenuItemSelected<T> = void Function(T value);

/// Signature for the callback invoked when a [OverlayMenuButton] is dismissed
/// without selecting an item.
///
/// Used by [OverlayMenuButton.onCanceled].
typedef PopupMenuCanceled = void Function();

/// Signature used by [OverlayMenuButton] to lazily construct the items shown when
/// the button is pressed.
///
/// Used by [OverlayMenuButton.itemBuilder].
...
/// then [OverlayMenuButton] behaves like an [IconButton].
///
...
class OverlayMenuButton<T> extends StatefulWidget {
  ...
  @override
  OverlayMenuButtonState<T> createState() => OverlayMenuButtonState<T>();
}

/// The [State] for a [OverlayMenuButton].
///
/// See [showButtonMenu] for a way to programmatically open the popup menu
/// of your button state.
class OverlayMenuButtonState<T> extends State<OverlayMenuButton<T>> {
  /// A method to show a popup menu with the items supplied to
  /// [OverlayMenuButton.itemBuilder] at the position of your [OverlayMenuButton].
  ///
  /// By default, it is called when the user taps the button and [OverlayMenuButton.enabled]
  /// is set to `true`. Moreover, you can open the button by calling the method manually.
  ///
  /// You would access your [OverlayMenuButtonState] using a [GlobalKey] and
